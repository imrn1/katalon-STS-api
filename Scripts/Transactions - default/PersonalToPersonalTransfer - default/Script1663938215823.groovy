...
def PersonalToPersonalTransferResponse = WS.sendRequestAndVerify(findTestObject('Postman/Transaction/PersonalToPersonalTransfer',[
...
CustomKeywords.'writeFile.WriteFile.writeExel'('PersonalToPersonalTransfer',"$process_description","$expected_status",
	"$expected_code","$expected_message", fileName="PersonalToPersonalTransfer","$expected_ResponseStatusCode")
...
WebUI.callTestCase(findTestCase('_Verify Cases/verify payloadNotBoolean'), [('servisName') : 'PersonalToPersonalTransfer'] )
