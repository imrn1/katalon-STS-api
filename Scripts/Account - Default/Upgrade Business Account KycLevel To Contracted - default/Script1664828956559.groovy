...
def UpgradeBusinessAccountKycLevelToContractedResponse = WS.sendRequestAndVerify(findTestObject('Postman/Account/UpgradeBusinessAccountKycLevelToContracted', 
        [
			('tenant_id') : "$tenant_id", 
...
CustomKeywords.'writeFile.WriteFile.writeExel'('UpgradeBusinessAccountKycLevelToContracted', "$process_description", "$expected_status", 
    "$expected_code", "$expected_message","UpgradeBusinessAccountKycLevelToContracted","$expected_ResponseStatusCode")
...
WebUI.callTestCase(findTestCase('_Verify Cases/verify payloadNotBoolean'), [('servisName') : 'UpgradeBusinessAccountKycLevelToContracted'] )
