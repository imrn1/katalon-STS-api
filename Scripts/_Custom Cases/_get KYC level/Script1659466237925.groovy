...
static int KYCLevel(String kycLevel){
	...
	if("$account_type"== "1") {
		...
		WS.verifyEqual("$account_type", "-1")  //  hata vermesi için
	}
	
	if(kycLevel != 0) {
		GlobalVariable.kycLevel_number = KYCLevel(kycLevel)
		GlobalVariable.kycLevel_str = kycLevel
		
	/*	println("account_type : "+"$account_type" + "\naccount_number : " + "$account_number" +
			 "\nkycLevel_number : " + GlobalVariable.kycLevel_number +
			 "\nkycLevel_str : " + GlobalVariable.kycLevel_str) */
	}
