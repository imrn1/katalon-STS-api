...
def TopupCashResponse = WS.sendRequestAndVerify(findTestObject('Postman/Transaction/TopupCash', [
...
CustomKeywords.'writeFile.WriteFile.writeExel'('TopupCash', "$process_description", "$expected_status", "$expected_code", 
    "$expected_message", fileName="TopupCash","$expected_ResponseStatusCode")
