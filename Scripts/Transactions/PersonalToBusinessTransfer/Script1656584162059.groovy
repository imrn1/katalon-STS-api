...
def PersonalToBusinessTransferResponse = WS.sendRequestAndVerify(findTestObject('Postman/Transaction/PersonalToBusinessTransfer',[
...
CustomKeywords.'writeFile.WriteFile.writeExel'('PersonalToBusinessTransfer',"$process_description","$expected_status",
	"$expected_code","$expected_message", fileName="PersonalToBusinessTransfer","$expected_ResponseStatusCode")
...
WebUI.callTestCase(findTestCase('_Verify Cases/verify payloadNotBoolean'), [('servisName') : 'PersonalToBusinessTransfer'] )
