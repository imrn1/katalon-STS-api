...
def CheckQRPaymentStatusREsponse = WS.sendRequestAndVerify(findTestObject('Postman/Transaction/CheckQRPaymentStatus',[
		"qr_code": "${qr_code}"
	]))


CustomKeywords.'writeFile.WriteFile.writeExel'('CheckQRPaymentStatus',"$process_description","$expected_status","$expected_code",
	"$expected_message", fileName="CheckQRPaymentStatus","$expected_ResponseStatusCode")
