...
CustomKeywords.'writeFile.WriteFile.writeExel'('CheckBusinessWallet', "$process_description", "$expected_status", "$expected_code", 
    "$expected_message",'CheckBusinessWallet',"$expected_ResponseStatusCode")
...
WebUI.callTestCase(findTestCase('_Verify Cases/verify payloadNotBoolean'), [('servisName') : 'CheckBusinessWallet'] )
