...
CustomKeywords.'writeFile.WriteFile.writeExel'('GetBusinessAccount', "$process_description", "$expected_status", "$expected_code", 
    "$expected_message","GetBusinessAccount","$expected_ResponseStatusCode")
...
WebUI.callTestCase(findTestCase('_Verify Cases/verify payloadNotBoolean'), [('servisName') : 'GetBusinessAccount'])
