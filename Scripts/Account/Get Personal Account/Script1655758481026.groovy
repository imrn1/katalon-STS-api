...
//file.append( GlobalVariable.requestObject.getBodyContent().getText()+"#")
...
CustomKeywords.'writeFile.WriteFile.writeExel'('GetPersonalAccount', "$process_description", "$expected_status", "$expected_code", 
    "$expected_message", 'GetPersonalAccount', "$expected_ResponseStatusCode")
...
WebUI.callTestCase(findTestCase('_Verify Cases/verify payloadNotBoolean'), [('servisName') : 'getPersonalAccount'])
