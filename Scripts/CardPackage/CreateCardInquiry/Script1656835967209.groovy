...
WS.sendRequestAndVerify(findTestObject('Postman/CardPackage/CreateCardInquiry',[
...
CustomKeywords.'writeFile.WriteFile.writeExel'('CreateCardInquiry',"$process_description","$expected_status","$expected_code",
	"$expected_message", fileName = "CreateCardInquiry","$expected_ResponseStatusCode")
...
WebUI.callTestCase(findTestCase('_Verify Cases/verify payloadNotBoolean'), [('servisName') : 'CreateCardInquiry'] )
