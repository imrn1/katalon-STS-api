...
def SetCardRandomPinResponse = WS.sendRequest(findTestObject('Postman/CardPackage/SetCardRandomPin'))

CustomKeywords.'writeFile.WriteFile.writeExel'('SetCardRandomPin',"$process_description","$expected_status","$expected_code",
	"$expected_message","SetCardRandomPin","$expected_ResponseStatusCode")
...
WebUI.callTestCase(findTestCase('_Verify Cases/verify payloadNotBoolean'), [('servisName') : 'SetCardRandomPin'] )
