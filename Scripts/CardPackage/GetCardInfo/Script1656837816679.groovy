...
def GetCardInfoResponse = WS.sendRequestAndVerify(findTestObject('Postman/CardPackage/GetCardInfo',[
...
CustomKeywords.'writeFile.WriteFile.writeExel'('GetCardInfo',"$process_description","$expected_status","$expected_code",
	"$expected_message","GetCardInfo","$expected_ResponseStatusCode")
...
WebUI.callTestCase(findTestCase('_Verify Cases/verify payloadNotBoolean'), [('servisName') : 'GetCardInfo'] )
