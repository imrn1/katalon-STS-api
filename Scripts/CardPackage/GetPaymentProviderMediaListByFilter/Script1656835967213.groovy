...
WS.sendRequestAndVerify(findTestObject('Postman/CardPackage/GetPaymentProviderMediaListByFilter', [
...
CustomKeywords.'writeFile.WriteFile.writeExel'('GetPaymentProviderMediaListByFilter',"$process_description","$expected_status","$expected_code"
	,"$expected_message","GetPaymentProviderMediaListByFilter","$expected_ResponseStatusCode")
...
WebUI.callTestCase(findTestCase('_Verify Cases/verify payloadNotBoolean'), [('servisName') : 'GetPaymentProviderMediaListByFilter'] )
