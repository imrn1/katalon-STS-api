...
CustomKeywords.'writeFile.WriteFile.writeExel'('GetClearCardNo',"$process_description","$expected_status",
	"$expected_code","$expected_message","GetClearCardNo","$expected_ResponseStatusCode")
...
WebUI.callTestCase(findTestCase('_Verify Cases/verify payloadNotBoolean'), [('servisName') : 'GetClearCardNo'] )
